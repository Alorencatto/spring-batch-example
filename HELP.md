...
* The original package name 'com.example.batch-processing' is invalid and this project uses 'com.example.batchprocessing' instead.
...
* [Spring Batch](https://docs.spring.io/spring-boot/docs/2.7.11/reference/htmlsingle/#howto.batch)
